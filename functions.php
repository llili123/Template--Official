...
function my_scripts() {
    ...
    wp_enqueue_script('fancybox-js', get_template_directory_uri() . '/js/jquery.fancybox.pack.js');
    wp_enqueue_script('fancybox-media', get_template_directory_uri() . '/js/jquery.fancybox-media.js');
    wp_enqueue_script('jquery-quicksand', get_template_directory_uri() . '/js/portfolio/jquery.quicksand.js');
    wp_enqueue_script('setting-js', get_template_directory_uri() . '/js/portfolio/setting.js');


    wp_enqueue_script('jquery-flexslider', get_template_directory_uri() . '/js/jquery.flexslider.js');
    wp_enqueue_script('animate-js', get_template_directory_uri() . '/js/animate.js');
